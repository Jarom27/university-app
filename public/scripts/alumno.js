...
modalEditar.forEach(boton => {
    boton.addEventListener("click",e =>{
        ...
        let dni = document.getElementById("editar_dni");
        ...
        console.log(dni);
        let nombre_real = array.children[2].children[0].textContent;
        console.log(nombre_real);
        let apellidos_real = array.children[2].children[1].textContent;
        dni.value = array.children[1].textContent
        nombre.value = nombre_real;
        apellidos.value = apellidos_real;
        email.value = array.children[3].textContent;
        direccion.value = array.children[4].textContent;
        fecha.value = array.children[5].textContent;
